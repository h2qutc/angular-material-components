...
@Injectable()
export class NgxMatLuxonDateAdapter extends NgxMatDateAdapter<LuxonDateTime> {
  ...
  override getHour(date: LuxonDateTime): number {
    return date.hour;
  }
  override getMinute(date: LuxonDateTime): number {
    return date.minute;
  }
  override getSecond(date: LuxonDateTime): number {
    return date.second;
  }
  override setHour(date: LuxonDateTime, value: number): LuxonDateTime {
    return date=date.set({hour: value});
  }
  override setMinute(date: LuxonDateTime, value: number): LuxonDateTime {
    return date.set({minute: value});
  }
  override setSecond(date: LuxonDateTime, value: number): LuxonDateTime {
  ...
  getDayOfWeekNames(style: 'long' | 'short' | 'narrow'): string[] {
    ...
    // https://luxon.github.io/luxon/api-docs/index.html#infoweekdays
